...
export default function BudgetTracker() {
 ...
 <div>
 <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-white/60">Budget Tracker</h2>
 ...
 className="bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border border-white/[0.06] rounded-2xl p-5">
 <h3 className="text-sm font-semibold text-white/80 mb-3 flex items-center gap-2">
 <BarChart3 size={14} className="text-zinc-300" /> Weekly Trend
 </h3>
 ...
 className="bg-zinc-900/50 backdrop-blur-md backdrop-blur-xl border border-zinc-700/50 rounded-2xl p-5">
 <div className="flex items-center justify-between mb-3">
 <h3 className="text-sm font-semibold text-zinc-300 flex items-center gap-2">
 <Lightbulb size={16} /> AI Budget Advisor
 </h3>
 <button onClick={getAdvice} disabled={generating}
 className="px-3 py-1.5 bg-zinc-800/50 text-zinc-300 text-xs rounded-lg hover:bg-zinc-700/50 transition-all flex items-center gap-1">
