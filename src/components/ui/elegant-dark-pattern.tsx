...
export function DarkGradientBg({ children, className }: DarkGradientBgProps) {
 ...
 >
 {/* Skewed fading blue streaks - animated */}
 <motion.div
 className="absolute inset-0 opacity-60"
 animate={{ x: [-20, 20, -20], opacity: [0.4, 0.8, 0.4] }}
 ...
 <motion.div
 className="absolute inset-0 opacity-60"
 animate={{ x: [-10, 30, -10], opacity: [0.3, 0.7, 0.3] }}
 ...
 <motion.div
 className="absolute inset-0 opacity-60"
 animate={{ x: [-30, 10, -30], opacity: [0.5, 0.9, 0.5] }}
 ...
 <div className="absolute inset-0 bg-gradient-radial from-cyan-900/30 via-transparent to-transparent" />
