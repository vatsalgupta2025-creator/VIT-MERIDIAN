...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
 ...
 {props.onChange && (
 <div
 className="absolute bottom-2 right-2 opacity-0 w-2 h-2 bg-zinc-800 rounded-full"
 style={{
 animation: 'none',
 }}
 id="textarea-ripple"
...
export function AnimatedAIChat() {
 ...
 >
 {msg.role === 'assistant' && (
 <div className="w-7 h-7 rounded-full text-zinc-100 flex items-center justify-center flex-shrink-0 mt-1">
 ...
 <div className="w-7 h-7 rounded-full text-zinc-100 flex items-center justify-center flex-shrink-0">
 <Sparkles className="w-3.5 h-3.5 text-white" />
 </div>
 ...
 {inputFocused && (
 <motion.div
 className="fixed w-[50rem] h-[50rem] rounded-full pointer-events-none z-0 opacity-[0.02] text-zinc-100 blur-[96px]"
 animate={{
...
function ActionButton({ icon, label }: ActionButtonProps) {
 ...
 <motion.span
 className="absolute bottom-0 left-0 w-full h-0.5 text-zinc-100"
 initial={{ width: 0 }}
