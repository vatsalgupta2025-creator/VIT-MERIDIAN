    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col h-full">
                ...
                {/* User card with Name & Registration Number */}
                <div className={`px-3 pb-4 ${collapsed ? 'px-2' : ''}`}>
                    <div
                        onClick={() => setIsEditModalOpen(true)}
                        title="Click to edit Name & Registration Number"
                        className={`flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] hover:bg-white/[0.07] border border-white/[0.06] hover:border-cyan-500/30 cursor-pointer transition-all group ${collapsed ? 'justify-center p-2' : ''}`}
                    >
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-violet-500 to-cyan-500 flex items-center justify-center flex-shrink-0 text-xs font-bold text-white shadow-md shadow-violet-500/20 group-hover:scale-105 transition-transform">
                            {user.avatar}
                        </div>
                        {!collapsed && (
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-[11px] font-mono text-white/40 truncate tracking-wider uppercase">
                                    {user.regNo}
                                </p>
                            </div>
                        )}
                        {!collapsed && (
                            <button
                                ...
                                title="Edit Name & Reg Number"
                                className="p-1 rounded-lg text-white/20 hover:text-cyan-400 hover:bg-white/[0.05] transition-colors"
                            >
                                <Edit3 size={14} />
                            </button>
                        )}
