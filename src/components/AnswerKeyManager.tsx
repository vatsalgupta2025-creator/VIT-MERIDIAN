...
export default function AnswerKeyManager() {
 ...
 <div className="w-20 h-20 rounded-2xl text-zinc-100 flex items-center justify-center mx-auto mb-6 shadow-lg shadow-violet-500/30">
 ...
 <item.icon size={20} className="text-zinc-300 mx-auto mb-2" />
 ...
 <button
 onClick={() => setShowWelcome(false)}
 className="w-full py-3 text-zinc-100 text-white font-semibold rounded-xl hover:opacity-90 transition-opacity"
 >
 Get Started
 </button>
 </div>
 ...
 className="w-14 h-14 rounded-2xl text-zinc-100 flex items-center justify-center shadow-lg shadow-violet-500/30 border border-white/10"
 >
 <BrainCircuit size={28} className="text-white" />
 </motion.div>
 <div>
 <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-white/60">Academic Toolkit</h2>
 ...
 <p className="text-xl font-bold text-zinc-300"><AnimatedCounter value={stats.totalQuestions} /></p>
 </div>
 <div className="px-4 py-2 bg-white/[0.03] rounded-xl border border-white/[0.06]">
 <p className="text-white/30 text-[10px] uppercase tracking-wider">Graded</p>
 <p className="text-xl font-bold text-zinc-300"><AnimatedCounter value={gradedResults.length} /></p>
 </div>
 <div className="px-4 py-2 bg-white/[0.03] rounded-xl border border-white/[0.06]">
 <p className="text-white/30 text-[10px] uppercase tracking-wider">Saved</p>
 <p className="text-xl font-bold text-zinc-300"><AnimatedCounter value={savedPapers.length} /></p>
 </div>
 </div>
 </div>
 ...
 <stat.icon size={14} className="text-zinc-300/60 mb-1" />
 ...
 className="w-full bg-black/30 border border-white/[0.08] rounded-xl p-4 text-sm text-white/90 placeholder:text-white/20 focus:outline-none focus:border-zinc-700/50 resize-none transition-all mb-4"
 rows={4}
 />
 ...
 className="flex-1 py-3.5 text-zinc-100 text-white font-semibold rounded-xl text-sm flex items-center justify-center gap-2 hover:opacity-90 disabled:opacity-30 transition-all shadow-lg shadow-emerald-500/20"
 >
 ...
 key={q.id}
 className="p-4 bg-white/[0.03] rounded-xl border border-white/[0.06] relative group hover:border-zinc-600/50 transition-colors"
 >
 <div className="flex gap-3">
 <div className="w-8 h-8 rounded-lg bg-zinc-800/50 text-zinc-300 flex items-center justify-center font-bold flex-shrink-0">
 {i + 1}
 </div>
 <div className="flex-1">
 <p className="text-white/80 text-sm mb-2">{q.questionText}</p>
 <div className="flex items-center gap-3 text-[11px]">
 <span className="px-2 py-0.5 bg-zinc-800/50 text-zinc-300 rounded">{q.marks} Marks</span>
 <span className={`px-2 py-0.5 rounded ${q.difficulty === 'easy' ? 'bg-green-500/15 text-green-400' : q.difficulty === 'medium' ? 'bg-amber-500/15 text-amber-400' : 'bg-zinc-800/50 text-zinc-300'}`}>
 {q.difficulty}
 </span>
 ...
 className="w-full bg-black/30 border border-white/[0.06] rounded-lg px-3 py-2 text-sm text-white/90 outline-none focus:border-zinc-700/50 transition-colors"
 />
 </div>
 ))}
 </div>
 ...
 <button onClick={() => loadPaper(paper)} className="p-1.5 text-white/40 hover:text-zinc-100"><Upload size={12} /></button>
 ...
 className="w-full bg-black/30 border border-white/[0.06] rounded-xl p-3 mb-3 text-sm text-white outline-none focus:border-zinc-700/50"
 >
 ...
 className="w-full bg-black/30 border border-white/[0.06] rounded-xl p-3 mb-3 text-sm text-white placeholder:text-white/20 outline-none focus:border-zinc-700/50"
 />
 ...
 className="w-full p-6 border-2 border-dashed border-white/[0.08] rounded-xl hover:border-zinc-600/50 hover:bg-zinc-700/50 transition-all text-center group mb-3"
 >
 <Upload size={24} className="text-white/20 group-hover:text-zinc-100 mx-auto mb-2 transition-colors" />
 ...
 className="w-full bg-black/30 border border-white/[0.06] rounded-xl p-4 min-h-[100px] text-sm text-white/80 focus:border-zinc-700/50 outline-none resize-none mb-3"
 />

 <button
 onClick={evaluateAnswer}
 disabled={aiGenerating || !extractedText || !studentName || !gradingQuestionId}
 className="w-full py-3.5 text-zinc-100 text-white font-semibold rounded-xl flex items-center justify-center gap-2 hover:opacity-90 disabled:opacity-30 transition-all shadow-lg shadow-blue-500/20"
 >
 ...
 <button onClick={exportGrades} className="text-xs text-zinc-300 hover:text-zinc-100">
 ...
 <span className={`text-lg font-bold ${r.score / r.maxMarks >= 0.7 ? 'text-zinc-300' : r.score / r.maxMarks >= 0.5 ? 'text-amber-400' : 'text-zinc-300'}`}>
 {r.score}/{r.maxMarks}
 </span>
 </div>
 ...
 <div className="h-full bg-zinc-800 rounded-full" style={{ width: `${r.confidence}%` }} />
 </div>
 ...
 <div className="w-16 h-16 rounded-2xl text-zinc-100 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-violet-500/20">
 ...
 className="bg-black/30 border border-white/[0.06] rounded-xl px-4 py-3 text-sm text-white outline-none focus:border-zinc-700/50"
 >
 ...
 className="w-full py-3.5 text-zinc-100 text-white font-semibold rounded-xl flex items-center justify-center gap-2 hover:opacity-90 disabled:opacity-30 transition-all shadow-lg shadow-violet-500/20"
 >
 ...
 >
 <div className="w-7 h-7 rounded-lg bg-zinc-800/50 text-zinc-300 flex items-center justify-center text-xs font-bold">
 {i + 1}
 </div>
 ...
 <p className="text-white/40 text-xs leading-relaxed border-l-2 border-zinc-700/50 pl-3">{q.a}</p>
 </motion.div>
 ))}
 </div>
 </GlassCard>
 ...
 : 'bg-white/[0.03] border-white/[0.06] hover:border-zinc-600/50'
 }`}
 onClick={() => {
 ...
 {day.completed && <CheckCircle2 size={12} className="text-zinc-300 mx-auto" />}
 </motion.div>
 ))}
 </div>
 </GlassCard>
 ...
 transition={{ delay: i * 0.1 }}
 className="h-full text-zinc-100 rounded-full"
 />
 </div>
 ...
 <div className={`w-2 h-2 rounded-full ${r.score / r.maxMarks >= 0.7 ? 'bg-zinc-800' : r.score / r.maxMarks >= 0.5 ? 'bg-amber-400' : 'bg-zinc-800'}`} />
 <div className="flex-1">
