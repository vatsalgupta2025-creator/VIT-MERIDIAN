...
export default function GroupStudy() {
 ...
 case 'upcoming': return 'bg-zinc-800/50 text-zinc-300 border-zinc-700/50';
 ...
 className="flex items-center gap-2 px-5 py-2.5 text-zinc-100 rounded-xl text-white font-medium text-sm hover:shadow-lg hover:shadow-emerald-500/20 transition-all"
 >
 <Plus size={18} />
 Host Session
 </button>
 ...
 className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-medium transition-all ${selectedType === type.id ? 'bg-zinc-800/50 text-zinc-300 border border-zinc-700/50' : 'bg-white/[0.03] text-white/50 border border-white/[0.06] hover:text-white/70'}`}
 >
 <type.icon size={14} />
 {type.label}
 </button>
 ...
 <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${session.status === 'live' ? 'bg-red-500/20' : 'bg-zinc-800/50'}`}>
 <TypeIcon size={24} className={session.status === 'live' ? 'text-red-400' : 'text-zinc-300'} />
 </div>
 <div>
 ...
 <span key={tag} className="px-2 py-1 rounded-md bg-white/[0.03] text-[11px] text-zinc-300/60 border border-zinc-700/50">
 #{tag}
 </span>
 ))}
 </div>
 ...
 <div className="w-8 h-8 rounded-full text-zinc-100 flex items-center justify-center text-xs font-bold text-white">
 {session.host.avatar}
 </div>
 ...
 className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-medium transition-all ${session.isJoined ? 'bg-zinc-800/50 text-zinc-300 border border-zinc-700/50' : 'bg-white/[0.06] text-white/70 hover:bg-zinc-700/50 hover:text-zinc-100'}`}
 >
 {session.isJoined ? (
 <>
 <CheckCircle size={14} />
 ...
 className={`flex-1 flex items-center justify-center gap-2 p-3 rounded-xl border transition-all ${newSession.type === type.id ? 'bg-zinc-800/50 border-zinc-700/50 text-zinc-300' : 'bg-white/[0.03] border-white/[0.06] text-white/50'}`}
 >
 <type.icon size={16} />
 {type.label}
 </button>
 ...
 className="flex-1 px-5 py-3 text-zinc-100 rounded-xl text-white font-medium hover:shadow-lg hover:shadow-emerald-500/20 transition-all flex items-center justify-center gap-2"
 >
 <Play size={16} />
 Host Session
 </button>
