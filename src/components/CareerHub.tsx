...
const ModernTemplate = ({ resume }: { resume: ResumeData }) => (
 ...
 <div className="border-l-4 border-zinc-700 pl-6 mb-6">
 ...
 {resume.summary && (
 <div className="mb-6">
 <h2 className="text-sm font-bold text-zinc-300 uppercase tracking-wider mb-2">Summary</h2>
 <p className="text-sm text-slate-700 leading-relaxed">{resume.summary}</p>
 </div>
 )}
 {resume.education.some(e => e.institution) && (
 <div className="mb-6">
 <h2 className="text-sm font-bold text-zinc-300 uppercase tracking-wider mb-3">Education</h2>
 ...
 <div className="mb-6">
 <h2 className="text-sm font-bold text-zinc-300 uppercase tracking-wider mb-3">Experience</h2>
 ...
 <div className="mb-6">
 <h2 className="text-sm font-bold text-zinc-300 uppercase tracking-wider mb-3">Projects</h2>
 ...
 <div className="mb-6">
 <h2 className="text-sm font-bold text-zinc-300 uppercase tracking-wider mb-3">Skills</h2>
...
const CreativeTemplate = ({ resume }: { resume: ResumeData }) => (
 <div className="text-zinc-100 text-slate-800 p-8 min-h-[800px] font-sans">
 <div className="bg-white rounded-2xl shadow-lg p-8 mb-6">
 <div className="flex items-center gap-4 mb-4">
 <div className="w-16 h-16 rounded-full text-zinc-100 flex items-center justify-center text-white text-2xl font-bold">
 ...
 <p className="text-xs text-zinc-300">{exp.company}</p>
 ...
 {resume.projects.filter(p => p.name).map((proj, i) => (
 <span key={i} className="text-zinc-100 text-slate-700 px-3 py-1.5 rounded-full text-xs font-medium">
 {proj.name}
 </span>
 ))}
 </div>
...
Return ONLY a JSON object like: {"feedback": ["tip1", "tip2", "tip3"], "suggestions": ["suggestion1", "suggestion2"], "atsTips": ["ats1", "ats2"]}`;
 ...
 bg: c === 'cyan' ? 'bg-zinc-800/50' : c === 'blue' ? 'bg-zinc-800/50' : c === 'violet' ? 'bg-zinc-800/50' : c === 'emerald' ? 'bg-zinc-800/50' : c === 'amber' ? 'bg-amber-500/15' : 'bg-zinc-800/50',
 text: c === 'cyan' ? 'text-zinc-300' : c === 'blue' ? 'text-zinc-300' : c === 'violet' ? 'text-zinc-300' : c === 'emerald' ? 'text-zinc-300' : c === 'amber' ? 'text-amber-400' : 'text-zinc-300',
 border: c === 'cyan' ? 'border-zinc-700/50' : c === 'blue' ? 'border-zinc-700/50' : c === 'violet' ? 'border-zinc-700/50' : c === 'emerald' ? 'border-zinc-700/50' : c === 'amber' ? 'border-amber-500/20' : 'border-zinc-700/50',
 });
 ...
 className="w-full bg-white/[0.03] border border-white/[0.06] rounded-lg px-3 py-2 text-xs text-white/80 placeholder:text-white/15 focus:outline-none focus:border-zinc-700/50 resize-none" />
 ) : (
 <input type="text" value={value} onChange={onChange} placeholder={placeholder}
 className="w-full bg-white/[0.03] border border-white/[0.06] rounded-lg px-3 py-2 text-xs text-white/80 placeholder:text-white/15 focus:outline-none focus:border-zinc-700/50" />
 )}
 </div>
 );
 ...
 if (score >= 80) return 'bg-zinc-800';
 ...
 <div className="w-14 h-14 rounded-2xl text-zinc-100 flex items-center justify-center shadow-md border border-white/10">
 ...
 ? `bg-gradient-to-r from-${tab.color}-500/20 to-${tab.color}-500/10 text-${tab.color}-400 shadow-md border border-${tab.color}-500/30`
 ...
 <div className="bg-white/[0.02] backdrop-blur-md rounded-2xl p-6 border border-white/[0.05] shadow-md">
 <h3 className="text-base font-bold text-white mb-5 flex items-center gap-2 drop-shadow-md">
 <div className="w-8 h-8 rounded-lg bg-zinc-800/50 flex items-center justify-center border border-zinc-700/50 shadow-inner">
 ...
 className="w-full bg-black/40 border border-white/[0.05] hover:border-zinc-600/50 rounded-xl p-4 text-sm text-white/90 placeholder:text-white/20 focus:outline-none focus:border-zinc-700/50 focus:ring-1 focus:ring-blue-500/40 resize-none transition-all" rows={4} />
 </div>
 <div className="grid grid-cols-2 gap-4">
 <div>
 ...
 className="w-full bg-black/40 border border-white/[0.05] hover:border-zinc-600/50 rounded-xl px-4 py-3 text-xs text-white/90 focus:outline-none focus:border-zinc-700/50 transition-all appearance-none cursor-pointer">
 ...
 className="w-full py-3.5 text-zinc-100 border border-zinc-700/50 text-white font-bold rounded-xl text-sm flex items-center justify-center gap-2 hover:opacity-90 hover:scale-[1.02] active:scale-95 disabled:opacity-30 disabled:hover:scale-100 transition-all shadow-md mt-2">
 ...
 <CheckCircle2 size={12} className="text-zinc-300/50 flex-shrink-0" /> {tip}
 </p>
 ))}
 </div>
 </div>
 ...
 {/* Generated Post */}
 <div className="bg-white/[0.02] backdrop-blur-md rounded-2xl p-6 border border-white/[0.05] flex flex-col relative overflow-hidden shadow-md">
 <div className="absolute top-0 right-0 w-64 h-64 bg-zinc-800/50 rounded-full blur-[80px] -mr-32 -mt-32 pointer-events-none" />
 ...
 className={`px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 transition-all ${copied ? 'bg-zinc-800/50 text-zinc-300 border border-zinc-700/50' : 'bg-zinc-800/50 text-zinc-300 border border-zinc-700/50 hover:bg-zinc-700/50 shadow-md'}`}>
 ...
 {/* Template Selection */}
 <div className="bg-white/[0.02] backdrop-blur-md rounded-2xl p-5 border border-white/[0.05] shadow-md">
 <div className="flex flex-col md:flex-row md:items-center justify-between mb-5 gap-4">
 <h3 className="text-base font-bold text-white flex items-center gap-2 drop-shadow-md">
 <div className="w-8 h-8 rounded-lg bg-zinc-800/50 flex items-center justify-center border border-zinc-700/50 shadow-inner">
 <LayoutTemplate size={16} className="text-zinc-300" />
 </div>
 Choose Template
 </h3>
 <div className="flex flex-wrap gap-3">
 ...
 disabled={analyzing}
 className="px-4 py-2 bg-zinc-900/50 backdrop-blur-md text-zinc-300 border border-zinc-700/50 rounded-xl text-xs font-bold flex items-center gap-2 hover:from-emerald-500/30 hover:to-teal-500/30 transition-all shadow-md"
 >
 {analyzing ? <><Loader2 size={14} className="animate-spin" /> Analyzing...</> : <><BarChart3 size={14} /> AI Analysis</>}
 </button>
 <button
 onClick={() => setShowPreview(!showPreview)}
 className={`px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 transition-all ${showPreview ? 'bg-zinc-800 text-white shadow-md hover:bg-zinc-700' : 'bg-zinc-800/50 text-zinc-300 border border-zinc-700/50 hover:bg-zinc-700/50 shadow-md'}`}
 >
 ...
 ? 'bg-zinc-800/50 border-zinc-700/50 shadow-md'
 ...
 <div className={`w-10 h-10 rounded-xl flex items-center justify-center mb-3 border ${selectedTemplate === t.id ? 'border-zinc-700/50 bg-zinc-800/50 shadow-inner' : 'border-white/5 bg-white/[0.03] group-hover:bg-white/[0.08] transition-colors'} relative z-10`}>
 <t.icon size={18} className={selectedTemplate === t.id ? 'text-zinc-300' : 'text-white/40 group-hover:text-white/80'} />
 </div>
 ...
 <p className={`text-[10px] mt-0.5 relative z-10 ${selectedTemplate === t.id ? 'text-zinc-300/70' : 'text-white/30'}`}>{t.description}</p>
 </button>
 ))}
 </div>
 </div>
 ...
 <div className="bg-white/[0.02] backdrop-blur-md rounded-2xl p-5 border border-white/[0.05] shadow-md sticky top-6">
 ...
 className={`w-full text-left flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${activeResumeSection === s.id ? 'bg-zinc-900/50 backdrop-blur-md text-zinc-300 border border-zinc-700/50 shadow-inner' : 'text-white/50 hover:text-white/90 hover:bg-white/[0.03] border border-transparent'}`}>
 ...
 className="w-full py-3 text-zinc-100 border border-zinc-700/50 text-white font-bold rounded-xl text-sm flex items-center justify-center gap-2 hover:opacity-90 hover:scale-[1.02] active:scale-95 disabled:opacity-30 disabled:hover:scale-100 transition-all shadow-md"
 >
 ...
 <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="bg-white/[0.02] backdrop-blur-md rounded-2xl p-6 border border-white/[0.05] shadow-md space-y-6">
 ...
 <p className="text-zinc-300 text-xs font-medium mb-2 flex items-center gap-1">
 <CheckCircle2 size={12} /> Strengths
 </p>
 <ul className="space-y-1">
 {resumeScore.feedback.map((f, i) => (
 <li key={i} className="text-white/50 text-[10px] flex items-start gap-1.5">
 <span className="text-zinc-300 mt-0.5">âœ“</span> {f}
 </li>
 ))}
 </ul>
 </div>
 ...
 <span key={i} className="text-[10px] text-white/50 bg-zinc-800/50 px-2 py-1 rounded">
 {t}
 </span>
 ))}
 </div>
 ...
 <Eye size={14} className="text-zinc-300" /> Preview: {templates.find(t => t.id === selectedTemplate)?.name}
 </h3>
 ...
 className="text-[10px] text-zinc-300 flex items-center gap-1"><Plus size={11} /> Add</button>
 </div>
 ...
 className="text-[10px] text-zinc-300 flex items-center gap-1"><Plus size={11} /> Add Category</button>
 </div>
 ...
 className="flex-1 bg-white/[0.03] border border-white/[0.06] rounded-lg px-3 py-2 text-xs text-white/80 placeholder:text-white/15 focus:outline-none focus:border-zinc-700/50" />
 ...
 {[
 { status: 'live', label: 'Live Now', icon: <div className="w-2 h-2 rounded-full bg-zinc-800 animate-pulse shadow-md" />, count: hackathons.filter(h => h.status === 'live').length, color: 'emerald' },
 { status: 'upcoming', label: 'Upcoming', icon: <Clock size={12} className="text-zinc-300" />, count: hackathons.filter(h => h.status === 'upcoming').length, color: 'blue' },
 ].map(f => (
 <div key={f.status} className={`bg-gradient-to-br from-${f.color}-500/10 to-${f.color}-500/5 rounded-2xl px-5 py-3 border border-${f.color}-500/20 flex items-center gap-3 backdrop-blur-md shadow-md`}>
 ...
 <div>
 <h3 className="text-sm font-bold text-zinc-300 uppercase tracking-widest mb-4 flex items-center gap-2 drop-shadow-md">
 <div className="w-2 h-2 rounded-full bg-zinc-800 animate-pulse" /> Live Now
 </h3>
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
 ...
 className="group relative bg-white/[0.02] backdrop-blur-md rounded-2xl p-5 border border-zinc-700/50 hover:border-zinc-600/50 transition-all duration-300 overflow-hidden shadow-md hover:shadow-md">

 {/* Glowing Background */}
 <div className="absolute inset-0 bg-zinc-900/50 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
 ...
 <span className="px-2.5 py-1 bg-zinc-800/50 text-zinc-300 text-[10px] font-black tracking-wider rounded-lg border border-zinc-700/50 shadow-md">LIVE</span>
 </div>
 <h4 className="text-white/95 text-base font-bold mb-1 relative z-10">{hack.name}</h4>
 <p className="text-zinc-300/60 text-xs font-medium mb-3 relative z-10">{hack.organizer}</p>
 ...
 <span className="text-[11px] font-bold text-amber-400 bg-amber-500/10 px-2 py-1 rounded-md border border-amber-500/20 shadow-md">ðŸ† {hack.prizes}</span>
 </div>
 </motion.a>
 );
 })}
 ...
 {/* Upcoming hackathons */}
 <div>
 <h3 className="text-sm font-bold text-zinc-300 uppercase tracking-widest mb-4 flex items-center gap-2 drop-shadow-md mt-6">
 <Clock size={14} className="text-zinc-300" /> Upcoming
 </h3>
 <div className="space-y-3">
 ...
 className={`group flex items-center gap-5 p-4 bg-white/[0.02] backdrop-blur-md rounded-2xl border border-white/[0.05] hover:border-${hack.color}-500/30 transition-all duration-300 relative overflow-hidden shadow-sm hover:shadow-md`}>
 ...
 <p className="text-xs text-zinc-300/80 font-medium flex items-center gap-1.5 bg-zinc-800/50 px-2.5 py-1 rounded-md border border-zinc-700/50"><Calendar size={11} /> {hack.date}</p>
