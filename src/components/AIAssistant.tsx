...
export default function AIAssistant() {
 ...
 className="fixed bottom-6 right-6 w-14 h-14 text-zinc-100 rounded-full flex items-center justify-center shadow-lg shadow-violet-500/30 z-50"
 >
 ...
 <div className="w-8 h-8 rounded-lg text-zinc-100 flex items-center justify-center">
 ...
 className="flex-1 bg-white/[0.05] border border-white/[0.08] rounded-xl px-4 py-2.5 text-sm text-white/90 placeholder:text-white/30 outline-none focus:border-zinc-700/50"
 />
 <button
 onClick={handleSend}
