...
export default function TravelPool() {
 ...
 switch (poolMode) {
 case 'Taxi': return <Car size={18} className="text-zinc-300" />;
 case 'Train': return <Train size={18} className="text-zinc-300" />;
 case 'Plane': return <Plane size={18} className="text-zinc-300" />;
 ...
 <Car className="text-zinc-300" size={24} />
 </div>
 </div>
 ...
 {/* Decorative gradient */}
 <div className="absolute top-0 right-0 w-32 h-32 bg-zinc-800/50 rounded-full blur-3xl -mr-10 -mt-10 pointer-events-none" />
 ...
 className="w-full bg-black/20 border border-white/10 rounded-xl py-2.5 pl-10 pr-4 text-white placeholder:text-white/20 focus:outline-none focus:border-zinc-700/50 focus:ring-1 focus:ring-cyan-500/50 transition-all text-sm"
 />
 </div>
 </div>
 ...
 className="w-full bg-black/20 border border-white/10 rounded-xl py-2.5 pl-10 pr-4 text-white/80 focus:outline-none focus:border-zinc-700/50 focus:ring-1 focus:ring-cyan-500/50 transition-all text-sm"
 ...
 className="w-full bg-black/20 border border-white/10 rounded-xl py-2.5 px-4 text-white placeholder:text-white/20 focus:outline-none focus:border-zinc-700/50 focus:ring-1 focus:ring-cyan-500/50 transition-all text-sm"
 />
 </div>
 ...
 <button
 type="submit"
 className="w-full mt-4 text-zinc-100 hover:from-cyan-400 hover:to-violet-400 text-white font-medium py-3 rounded-xl transition-all shadow-md hover:shadow-md flex items-center justify-center gap-2"
 >
 ...
 className="w-full bg-white/[0.03] backdrop-blur-xl border border-white/[0.06] rounded-xl py-2.5 pl-10 pr-4 text-white placeholder:text-white/30 focus:outline-none focus:border-zinc-700/50 transition-all text-sm"
 />
 </div>
 ...
 className="text-xs text-zinc-300 hover:text-zinc-100 flex items-center gap-1 bg-zinc-800/50 px-2 py-1 rounded-md"
 >
 <Phone size={10} />
 {traveler.phone}
 </a>
