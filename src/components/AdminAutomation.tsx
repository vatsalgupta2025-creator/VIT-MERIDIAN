...
export default function AdminAutomation() {
 ...
 switch (status) {
 case 'active': return 'bg-zinc-800/50 text-zinc-300 border-zinc-700/50';
 ...
 <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${log.status === 'success' ? 'bg-zinc-800/50' : log.status === 'failed' ? 'bg-red-500/20' : 'bg-zinc-500/20'}`}>
 {log.status === 'success' ? <CheckCircle size={16} className="text-zinc-300" /> :
