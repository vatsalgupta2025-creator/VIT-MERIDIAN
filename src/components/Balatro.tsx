    ...
    useEffect(() => {
        ...
        const init = async () => {
            try {
                ...
                // Initial size — wait a tick for layout to settle
                ...
                // Resize again after program creation
                resize();
                ...
                console.error('Balatro shader init error:', err);
            }
        };
        ...
        return () => {
            ...
            if (cleanup) cleanup();
            if (canvasRef && canvasRef.parentNode === container) {
                container.removeChild(canvasRef);
            }
            if (glRef) {
