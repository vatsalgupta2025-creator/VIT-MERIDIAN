...
const typeIcons: Record<string, React.ReactNode> = {
 ...
 VIDEO: <Video size={14} className="text-zinc-300" />,
 DOCX: <FileText size={14} className="text-zinc-300" />,
 CODE: <Code size={14} className="text-zinc-300" />,
 NOTES: <BookOpen size={14} className="text-zinc-300" />,
};
...
export default function SearchBar() {
 ...
 className="mr-2 px-4 py-1.5 rounded-xl text-zinc-100 text-white text-xs font-medium hover:opacity-90 transition-opacity flex items-center gap-1.5 shadow-lg shadow-cyan-500/20"
 >
 <Sparkles size={12} />
 Search
 </button>
 ...
 <p className="text-sm text-white/80 font-medium truncate group-hover:text-zinc-100 transition-colors">
