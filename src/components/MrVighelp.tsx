...
`;
 ...
 className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full text-zinc-100 flex items-center justify-center shadow-lg shadow-cyan-500/20 hover:scale-105 transition-all duration-300 group"
 >
 ...
 <div className="w-10 h-10 rounded-full text-zinc-100 flex items-center justify-center shadow-inner">
 ...
 className="w-full text-left px-4 py-2 text-sm text-white/70 hover:bg-white/5 hover:text-zinc-100 flex items-center justify-between"
 >
 {lang.name}
 {language.code === lang.code && <Check size={14} className="text-zinc-300" />}
 </button>
 ))}
 </div>
 )}
 ...
 className="p-1.5 text-white/40 hover:text-zinc-100 hover:bg-white/5 rounded-lg transition-colors"
 ...
 ? 'text-zinc-100 text-white rounded-br-none'
 : msg.type === 'system'
 ...
 .replace(/\*(.*?)\*/g, '<em>$1</em>')
 .replace(/`(.*?)`/g, '<code class="bg-black/30 px-1 py-0.5 rounded text-zinc-300 font-mono text-xs">$1</code>')
 }}
 />
 ...
 className="p-2.5 text-white/40 hover:text-zinc-100 hover:bg-white/5 rounded-xl transition-colors shrink-0"
 title="Upload Image/File"
 >
 <Paperclip size={20} />
 </button>

 <div className="relative flex-1 bg-white/[0.03] border border-white/10 rounded-xl focus-within:border-zinc-700/50 focus-within:bg-white/[0.05] transition-all">
 <input
 type="text"
 value={input}
 ...
 ? 'bg-red-500/20 text-red-500 border border-red-500/30 shadow-md'
 ...
 className="p-2.5 bg-zinc-800 text-white rounded-xl shadow-lg shadow-cyan-500/20 hover:bg-zinc-700 disabled:opacity-50 disabled:hover:bg-zinc-700 transition-all shrink-0"
 >
 <Send size={20} />
 </button>
 </form>
