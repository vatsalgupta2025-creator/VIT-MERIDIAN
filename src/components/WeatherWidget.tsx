...
export default function WeatherWidget() {
 ...
 <Droplets size={11} className="text-zinc-300/60 mx-auto mb-0.5" />
 <p className="text-[10px] text-white/40">{current.humidity}%</p>
 </div>
 <div className="text-center">
 <Wind size={11} className="text-zinc-300/60 mx-auto mb-0.5" />
 <p className="text-[10px] text-white/40">{Math.round(current.wind_kph)} km/h</p>
 </div>
 <div className="text-center">
 <Eye size={11} className="text-zinc-300/60 mx-auto mb-0.5" />
 ...
 {h.chance_of_rain > 30 && (
 <p className="text-[8px] text-zinc-300/50">💧{h.chance_of_rain}%</p>
 )}
 </div>
 );
 })}
 ...
 <p className="text-[8px] text-zinc-300/40 mt-0.5">💧{day.day.daily_chance_of_rain}%</p>
 )}
 </div>
 );
 })}
 ...
 <div className="flex items-center gap-1.5">
 <Sunset size={10} className="text-zinc-300/50" />
