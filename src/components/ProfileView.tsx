...
export default function ProfileView() {
 ...
 >
 <div className="absolute top-0 right-0 w-64 h-64 bg-zinc-800/50 rounded-full blur-[90px] -mr-20 -mt-20 pointer-events-none" />
 <div className="absolute bottom-0 left-0 w-64 h-64 bg-zinc-800/50 rounded-full blur-[90px] -ml-20 -mb-20 pointer-events-none" />

 <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-6 text-center md:text-left">
 <div className="w-24 h-24 rounded-3xl text-zinc-100 flex items-center justify-center text-3xl font-black text-white shadow-xl shadow-cyan-500/20 flex-shrink-0">
 {user.avatar}
 </div>
 ...
 <span className="px-3 py-0.5 rounded-full bg-zinc-800/50 border border-zinc-700/50 text-zinc-300 font-mono text-xs font-semibold tracking-wider uppercase">
 {user.regNo}
 </span>
 </div>
 ...
 <div className="w-10 h-10 rounded-xl bg-zinc-800/50 flex items-center justify-center text-zinc-300">
 <BookOpen size={18} />
 </div>
 <div>
 ...
 <p className="text-lg font-bold text-zinc-300">{user.totalPoints}</p>
 </div>
 </div>
 ...
 <p className="text-lg font-bold text-zinc-300">{user.ruviScore}</p>
 </div>
 </div>
 ...
 {savedNotice && (
 <span className="px-3 py-1 rounded-lg bg-zinc-800/50 border border-zinc-700/50 text-zinc-300 text-xs font-semibold flex items-center gap-1.5 animate-in fade-in">
 ...
 required
 className="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] focus:border-zinc-700/50 focus:bg-white/[0.07] text-white placeholder-white/20 text-sm outline-none transition-all"
 />
 </div>

 <div>
 <label className="block text-xs font-medium text-white/60 mb-2 flex items-center gap-1.5">
 <Hash size={13} className="text-zinc-300" />
 Registration Number
 </label>
 <input
 type="text"
 ...
 required
 className="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] focus:border-zinc-700/50 focus:bg-white/[0.07] text-white placeholder-white/20 text-sm outline-none transition-all uppercase tracking-wider font-mono"
 />
 </div>
 ...
 <button
 type="submit"
 className="px-6 py-3 rounded-xl text-zinc-100 hover:from-cyan-400 hover:to-violet-500 text-white text-sm font-semibold shadow-lg shadow-cyan-500/25 transition-all flex items-center gap-2"
 >
 <Check size={16} />
 Save Identification
 </button>
