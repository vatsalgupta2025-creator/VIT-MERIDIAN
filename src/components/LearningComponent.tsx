...
const recentActivity = [
 { date: 'Feb 19', xp: 54, color: 'bg-zinc-800' },
 { date: 'Feb 17', xp: 31, color: 'bg-zinc-800' },
 { date: 'Feb 16', xp: 40, color: 'bg-zinc-800' },
];
...
Do not include any other text, just the JSON array.` }]
 ...
 if (level === 1) return 'bg-zinc-800/50';
 if (level === 2) return 'bg-zinc-800/50';
 if (level === 3) return 'bg-zinc-800/50';
 return 'bg-zinc-800';
 };
 ...
 <div className="text-center">
 <p className="text-lg font-black text-zinc-300">129</p>
 <p className="text-[9px] text-white/30 uppercase">Active Days</p>
 </div>
 <div className="text-center">
 <p className="text-lg font-black text-zinc-300">5</p>
 ...
 <div className="w-2.5 h-2.5 rounded-full bg-zinc-800 ring-1 ring-white/20" />
 </div>
 </div>
 ...
 <span className="text-xs font-bold text-zinc-300">+{act.xp} XP</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="absolute top-2.5 left-2.5 w-6 h-6 rounded-full bg-zinc-800 flex items-center justify-center text-white shadow-lg">
 <CheckCircle size={14} />
 </div>
 )}
 {/* Bookmark */}
 ...
 <h3 className="text-[13px] font-semibold text-white/90 line-clamp-2 leading-snug group-hover:text-zinc-100 transition-colors">
 {video.title}
 </h3>
 </div>
 </motion.div>
 ...
 <GraduationCap className="text-zinc-300" size={20} /> AI Knowledge Quiz
 </h3>
 ...
 <CheckCircle size={28} className="text-zinc-300 mx-auto mb-2" />
 <h4 className="font-bold text-zinc-300 text-sm">Module Mastered! ðŸŽ‰</h4>
 <p className="text-[11px] text-zinc-300/60 mt-1">XP already claimed.</p>
 </div>
 ) : isGeneratingQuiz ? (
 <div className="text-center py-10">
 <Loader2 size={28} className="text-zinc-300 animate-spin mx-auto mb-3" />
 ...
 <button onClick={handleQuizPass} className="w-full py-2.5 rounded-xl text-zinc-100 text-white font-bold text-sm mb-2">
 ...
 let cls = 'border-white/5 bg-white/[0.02] text-white/70 hover:bg-white/[0.05] hover:border-zinc-600/50';
 if (showExplanation) {
 if (i === quizQuestions[quizIndex].correctAnswer) cls = 'border-zinc-700/50 bg-zinc-800/50 text-zinc-300';
 ...
 className="flex-1 py-2.5 rounded-xl text-zinc-100 text-white font-bold text-sm disabled:opacity-40">
 Submit
 </button>
 ) : (
 <button onClick={() => {
 ...
 <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-zinc-800/50 border border-zinc-700/50 text-xs font-bold text-zinc-300">
