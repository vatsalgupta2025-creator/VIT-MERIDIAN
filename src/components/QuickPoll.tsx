...
export default function QuickPoll() {
 ...
 switch (category) {
 case 'academic': return 'text-zinc-300 bg-zinc-800/50 border-zinc-700/50';
 case 'event': return 'text-zinc-300 bg-zinc-800/50 border-zinc-700/50';
 case 'feedback': return 'text-zinc-300 bg-zinc-800/50 border-zinc-700/50';
