...
function HeatmapCell({ value, max }: { value: number; max: number }) {
 ...
 const bg =
 intensity > 0.8 ? 'bg-zinc-800' :
 intensity > 0.6 ? 'bg-zinc-800/50' :
 intensity > 0.4 ? 'bg-zinc-800/50' :
 intensity > 0.2 ? 'bg-zinc-800/50' :
 intensity > 0 ? 'bg-zinc-800/50' : 'bg-white/[0.03]';
...
export default function PulseDashboard() {
 ...
 <StatCard label="RUVI Score" value={currentUser.ruviScore} icon={Target} color="text-zinc-300" suffix="/100" />
 <StatCard label="XP Points" value={currentUser.totalPoints} icon={Zap} color="text-zinc-300" />
 <StatCard label="Day Streak" value={currentUser.streak} icon={Flame} color="text-amber-400" />
 <StatCard label="Vit-Meridian Rank" value={currentUser.rank} icon={Trophy} color="text-zinc-300" suffix="th" />
 </div>
 ...
 <div className="w-6 h-6 rounded-lg text-zinc-100 flex items-center justify-center">
 ...
 {/* Gamification badge */}
 <div className="bg-zinc-900/50 backdrop-blur-md border border-white/[0.06] rounded-2xl p-5 flex items-center justify-between">
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 rounded-xl text-zinc-100 flex items-center justify-center shadow-lg shadow-violet-500/20">
 ...
 <div
 className="h-full rounded-full text-zinc-100"
