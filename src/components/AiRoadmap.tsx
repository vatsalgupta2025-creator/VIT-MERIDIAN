...
export default function AiRoadmap() {
 ...
 <div className="absolute top-0 right-0 w-96 h-96 bg-zinc-800/50 rounded-full blur-[100px] pointer-events-none" />
 <div className="absolute bottom-0 left-0 w-96 h-96 bg-zinc-800/50 rounded-full blur-[100px] pointer-events-none" />

 <div className="relative z-10 max-w-2xl">
 <h2 className="text-3xl font-bold text-zinc-100 mb-2 flex items-center gap-3">
 <MapIcon className="text-zinc-300" size={32} />
 AI Learning Roadmap
 </h2>
 ...
 className="w-full pl-12 pr-4 py-4 bg-white/5 border border-white/10 rounded-2xl text-white placeholder-white/30 focus:outline-none focus:border-zinc-700/50 focus:bg-white/10 transition-all font-medium"
 ...
 className="px-8 py-4 text-zinc-100 text-white rounded-2xl font-bold hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2 shrink-0 group"
 >
 {isGenerating ? (
 <>
 ...
 <div className="w-16 h-16 border-4 border-zinc-700/50 border-t-cyan-500 rounded-full animate-spin mx-auto mb-6" />
 ...
 <div className="text-sm font-medium text-zinc-300 bg-zinc-800/50 px-4 py-2 rounded-xl">
 ...
 className={`absolute -left-[17px] top-1 w-8 h-8 rounded-full border-4 border-[#040812] flex items-center justify-center transition-all duration-300 ${step.isCompleted ? 'bg-zinc-800 text-white' : 'bg-white/10 text-transparent hover:bg-white/20'
 }`}
 >
 ...
 <div>
 <div className="text-zinc-300 text-sm font-semibold mb-1 uppercase tracking-wider flex items-center gap-2">
 Phase {index + 1}
 ...
 className="flex items-center gap-3 p-2 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.05] hover:border-zinc-600/50 transition-all group"
 >
 ...
 <h6 className="text-xs font-medium text-white/90 line-clamp-2 group-hover:text-zinc-100 transition-colors">{video.title}</h6>
 ...
 <div className="bg-zinc-900/50 backdrop-blur-md border border-zinc-700/50 rounded-3xl p-6 sticky top-6">
 ...
 <p className="text-lg font-bold text-zinc-300">{roadmap.topic}</p>
 </div>
 ...
 <Clock className="text-zinc-300 mb-2" size={20} />
 ...
 <div className="bg-black/20 p-4 rounded-xl border border-white/5">
 <Target className="text-zinc-300 mb-2" size={20} />
