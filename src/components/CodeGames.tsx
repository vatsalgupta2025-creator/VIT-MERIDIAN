...
export default function CodeGames() {
 ...
 {/* Hero Section */}
 <div className="relative overflow-hidden rounded-2xl bg-zinc-900/50 backdrop-blur-md p-8 border border-white/10">
 <div className="absolute top-0 right-0 w-64 h-64 bg-zinc-800/50 rounded-full blur-3xl" />
 <div className="relative z-10">
 <div className="flex items-center gap-3 mb-4">
 <div className="w-12 h-12 rounded-xl text-zinc-100 flex items-center justify-center">
 ...
 className="group relative overflow-hidden rounded-xl bg-zinc-900/50 backdrop-blur-md p-6 border border-white/10 hover:border-zinc-600/50 transition-all text-left"
 >
 <div className="absolute inset-0 bg-zinc-900/50 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity" />
 <Puzzle className="text-zinc-300 mb-3" size={28} />
 ...
 <ChevronRight className="absolute right-4 top-1/2 -translate-y-1/2 text-white/20 group-hover:text-zinc-100 transition-colors" />
 </button>
 ...
 >
 <div className="absolute inset-0 bg-zinc-900/50 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity" />
 <Bug className="text-zinc-300 mb-3" size={28} />
 ...
 >
 <div className="absolute inset-0 bg-zinc-900/50 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity" />
 <Keyboard className="text-zinc-300 mb-3" size={28} />
 ...
 >
 <div className="absolute inset-0 bg-zinc-900/50 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity" />
 <Code className="text-zinc-300 mb-3" size={28} />
 ...
 {isCompleted && (
 <CheckCircle size={18} className="text-zinc-300" />
 )}
 </div>
 ...
 <span className="text-sm font-bold text-zinc-300">{streak}🔥</span>
 </div>
 </div>
 </div>
 ...
 <div className="flex items-center gap-2">
 {currentQuestion.type === 'multiple-choice' && <Target size={16} className="text-zinc-300" />}
 {currentQuestion.type === 'fill-blank' && <Puzzle size={16} className="text-zinc-300" />}
 {currentQuestion.type === 'debug' && <Bug size={16} className="text-zinc-300" />}
 {currentQuestion.type === 'typing' && <Keyboard size={16} className="text-zinc-300" />}
 {currentQuestion.type === 'code-output' && <Code size={16} className="text-zinc-300" />}
 {currentQuestion.type === 'true-false' && <CheckCircle size={16} className="text-zinc-300" />}
 <span className="text-xs font-medium text-white/60 capitalize">
 {currentQuestion.type.replace('-', ' ')}
 </span>
 </div>
 <span className={`text-xs font-medium px-2 py-1 rounded ${currentQuestion.difficulty === 'beginner' ? 'bg-zinc-800/50 text-zinc-300' :
 ...
 <pre className="text-zinc-300 whitespace-pre-wrap">{currentQuestion.code}</pre>
 </div>
 )}
 ...
 : 'bg-white/[0.02] border-white/[0.06] hover:bg-white/[0.05] hover:border-zinc-600/50 text-white/80'
 }`}
 >
 ...
 className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-zinc-700/50 font-mono"
 autoFocus
 />
 {!showExplanation && (
 <button
 ...
 className="w-full py-3 rounded-xl text-zinc-100 text-white font-bold text-sm disabled:opacity-50 disabled:cursor-not-allowed"
 >
 Submit Answer
 </button>
 )}
 {showExplanation && (
 <div className={`p-3 rounded-xl ${isCorrect ? 'bg-zinc-800/50 border border-zinc-700/50' : 'bg-red-500/20 border border-red-500/30'}`}>
 <p className={`text-sm ${isCorrect ? 'text-zinc-300' : 'text-red-300'}`}>
 ...
 {isCorrect ? (
 <CheckCircle className="text-zinc-300 flex-shrink-0 mt-0.5" size={20} />
 ) : (
 <XCircle className="text-red-400 flex-shrink-0 mt-0.5" size={20} />
 )}
 <div>
 <p className={`text-sm font-medium mb-1 ${isCorrect ? 'text-zinc-300' : 'text-red-400'}`}>
 ...
 className="mt-4 w-full py-3 rounded-xl text-zinc-100 text-white font-bold text-sm hover:opacity-90 transition-opacity"
 >
 ...
 <p className="text-5xl font-black text-transparent bg-clip-text text-zinc-100">
 {score}
 </p>
 ...
 <div>
 <p className="text-2xl font-bold text-zinc-300">{streak}</p>
 ...
 <button
 onClick={() => setGameMode('select-language')}
 className="flex items-center gap-2 px-6 py-3 rounded-xl text-zinc-100 text-white font-bold hover:opacity-90 transition-opacity"
 >
 More Languages
 </button>
 </div>
