...
export default function TodoList() {
 ...
 <ListTodo size={16} className="text-zinc-300" />
 Task Master
 </h3>
 ...
 className="w-full bg-white/[0.03] border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white placeholder-white/30 focus:outline-none focus:border-zinc-700/50 focus:bg-white/[0.05] transition-all"
 />
 <button
 type="submit"
 className="absolute right-2 top-1/2 -translate-y-1/2 w-7 h-7 flex items-center justify-center rounded-lg bg-zinc-800/50 text-zinc-300 hover:bg-zinc-700/50 transition-colors"
 >
 <Plus size={14} />
 </button>
 </form>
 ...
 className={`mt-0.5 flex-shrink-0 transition-colors ${task.completed ? 'text-zinc-300' : 'text-white/20 group-hover:text-zinc-100'
 }`}
 >
