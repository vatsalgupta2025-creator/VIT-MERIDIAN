...
export default function BootScreen({ onComplete }: BootScreenProps) {
 ...
 <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-zinc-800/50 rounded-full blur-[100px] animate-pulse" />
 <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-zinc-800/50 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '1s' }} />
 ...
 className="mt-8 w-16 h-16 rounded-full bg-zinc-800/50 flex items-center justify-center border border-zinc-700/50 shadow-md"
 >
 ...
 {/* Cover Design */}
 <div className="w-[85%] h-[92%] border border-zinc-700/50 rounded-xl flex flex-col items-center justify-center relative overflow-hidden bg-black/20">
 ...
 className="w-24 h-24 mb-8 rounded-full text-zinc-100 p-1 shadow-md"
 >
 ...
 <h1 className="text-4xl md:text-5xl font-black tracking-widest text-transparent bg-clip-text text-zinc-100 relative z-10 px-4 text-center">
 VIT-MERIDIAN
 </h1>
 <p className="text-zinc-300/80 tracking-[0.4em] text-xs mt-4 relative z-10 font-bold">SMART CAMPUS OS</p>
 </div>
