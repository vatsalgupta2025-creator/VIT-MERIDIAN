...
export default function ClubsEvents() {
 ...
 {/* Hero Section */}
 <div className="relative overflow-hidden rounded-3xl bg-zinc-900/50 backdrop-blur-md p-10 border border-white/10">
 ...
 <span className="px-3 py-1 rounded-full bg-zinc-800/50 text-zinc-300 text-xs font-bold tracking-wider uppercase border border-zinc-700/50">Featured</span>
 <span className="flex items-center gap-1.5 text-white/60 text-sm"><Flame size={14} className="text-zinc-300" /> Hot Right Now</span>
 </div>
 ...
 <button className="px-6 py-3 rounded-xl bg-white text-black font-bold hover:scale-105 transition-transform shadow-md">
 Register Now
 </button>
 </div>
 <div className="text-9xl filter drop-shadow-md">
 🎪
 </div>
 </div>
 </div>
 ...
 className="w-full bg-white/[0.03] border border-white/10 rounded-xl py-2.5 pl-10 pr-4 text-white placeholder:text-white/30 focus:outline-none focus:border-zinc-700/50 transition-colors" />
 </div>
 </div>
 ...
 <div key={i} className="group relative overflow-hidden rounded-2xl bg-white/[0.02] border border-white/10 p-4 md:p-6 hover:border-zinc-600/50 transition-colors flex flex-col md:flex-row md:items-center gap-6 cursor-pointer">
 <div className="absolute inset-0 bg-zinc-900/50 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
 ...
 <span className="px-2.5 py-1 rounded-md bg-zinc-800/50 text-zinc-300 text-[10px] font-bold uppercase border border-zinc-700/50">{event.type}</span>
 </div>
 <h3 className="text-xl md:text-2xl font-bold text-white mb-3 group-hover:text-zinc-100 transition-colors">{event.title}</h3>
 ...
 <button className="w-full md:w-12 md:h-12 py-3 md:py-0 rounded-xl bg-white/5 hover:bg-zinc-700/50 border border-white/10 text-white flex items-center justify-center transition-all group-hover:scale-110 group-hover:text-zinc-100">
